...
public class ConexionBD {
    ...
    public static Connection conectarBaseDatos() {
        ...
        String user = "/*usuario Bd*/"; // Nombre de Usuario para el acceso a la base de datos
        String pass = "/*contraseñan Bd*/"; // Contraseña del Usuario para el acceso a la base de datos
        String baseDatos ="/*nombre Bd*/"; // Nombre de la base de datos
